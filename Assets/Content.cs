...
public class Content : MonoBehaviour
{
    ...
    //ћетод только добавл€ет в Ѕƒ полученные значени€
    ...
    //ѕолучаем ID первого сто€щего на отгрузку объекта
    ...
    //ѕолучение количества объектов на выходе по id_content
    ...
    //ѕолучение имени выгружаемого объекта по id_content
    ...
    //‘ормирование запроса на удаление записи
    ...
    //ѕолучаем дату выгрузки предмета(который еще находитс€ в производстве) по номеру слота и имени главного объекта
