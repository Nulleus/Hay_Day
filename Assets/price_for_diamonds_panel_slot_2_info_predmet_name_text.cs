...
public class price_for_diamonds_panel_slot_2_info_predmet_name_text : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "indigo") { gameObject.GetComponent<Text>().text = "Индиго"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "pumpkin") { gameObject.GetComponent<Text>().text = "Тыква"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "apple") { gameObject.GetComponent<Text>().text = "Яблоко"; }
        ...
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "corn_bread") { gameObject.GetComponent<Text>().text = "Кукурузный хлеб"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "brown_sugar") { gameObject.GetComponent<Text>().text = "Коричневый сахар"; }
        ...
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "pancake") { gameObject.GetComponent<Text>().text = "Блин"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "pig_feed") { gameObject.GetComponent<Text>().text = "Свиной корм"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "bacon") { gameObject.GetComponent<Text>().text = "Бекон"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "cookie") { gameObject.GetComponent<Text>().text = "Печенье"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "bacon_and_aggs") { gameObject.GetComponent<Text>().text = "Яичница с беконом"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "cheese") { gameObject.GetComponent<Text>().text = "Сыр"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "white_sugar") { gameObject.GetComponent<Text>().text = "Белый сахар"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "carrot_pie") { gameObject.GetComponent<Text>().text = "Морковный пирог"; }
        if (globals.price_for_diamonds_panel_slot_2_predmet_name == "pumpkin_pie") { gameObject.GetComponent<Text>().text = "Тыквенный пирог"; }
    }
}
