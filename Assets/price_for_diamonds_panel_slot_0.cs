...
public class price_for_diamonds_panel_slot_0 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "cow_feed") { anim.CrossFade("cow_feed", 0); }
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "milk") { anim.CrossFade("milk", 0); }
        ...
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "soybean") { anim.CrossFade("soybean", 0); }
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "sugarcane") { anim.CrossFade("sugarcane", 0); }
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "carrot") { anim.CrossFade("carrot", 0); }
        if (globals.price_for_diamonds_panel_slot_0_predmet_name == "pumpkin") { anim.CrossFade("pumpkin", 0); }
    }
