...
public class bread : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject.Find("bakery").GetComponent<bakery>().event_0 = "pizda vashe";
    ...
    void OnCollisionEnter2D(Collision2D other)//При столкновении
    {
        ...
        if ((gameObject.name == "bread") && (other.gameObject.name == "slot_0_bakery_frame")) //Загрузка хлеба в slot_backery_0_0
        {
