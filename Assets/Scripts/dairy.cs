...
public class dairy : MonoBehaviour
{
    ...
    void Event_System()
    {
        if (event_0 == "add_cream")
        {
            add_in_slot_predmet("cream");
            event_0 = "";
        }
        if (event_0 == "add_butter")
        {
            add_in_slot_predmet("butter");
            event_0 = "";
        }
        if (event_0 == "add_cheese")
        {
            add_in_slot_predmet("cheese");
            event_0 = "";
        }
    }
    ...
    void otgruzka_predmeta()
    {
        ...
        if (array_slots_zagruzki[0, 0] != "")//Если слот_0  не пустой 
        {
            ...
            //Разница дат
            if (GameObject.Find("slot_0_dairy_text"))
            {
                GameObject.Find("slot_0_dairy_text").GetComponent<Text>().text = time.Seconds + " c";
                if (time.Seconds == 0) { GameObject.Find("slot_0_dairy_text").GetComponent<Text>().text = ""; }//Если 0 секунд, убрать текст
            }
