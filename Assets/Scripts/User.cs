...
public class User : MonoBehaviour
{
    ...
    public void PostLogin()
    {
        ...
        RestClient.Post<ResponseInfo>("http://89.110.90.192/api/login.php", new POSTLogin
        {
            login = Login,
            password = Password
        }).Then(response => {
    ...
    public int GetUserInfoAPIExperiencePoints()
    {
        ...
        RestClient.Post<ResponseUserInfoExperiencePoints>("http://89.110.90.192/api/user_execute_methods.php", new POSTUser
        {
            jwt = JWTToken,
